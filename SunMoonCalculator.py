...
class SunMoonCalculator:
    ...
    class Ephemeris(object):
        ...
        def __init__(self, azimuth, elevation, rise, set, transit, transitElevation, distance, rightAscension, 
...
try:
    ...
    latitud  =  math.radians(28.606)
    longitud =  math.radians(-17.778)# ¡// lon is negative to the west

    smc = SunMoonCalculator(year, month, day, h, m, s, longitud, latitud)
    smc.calcSunAndMoon()
    degSymbol = "\u00b0"
    print("###SUN###")
    print(" Az:       ",(smc.sun.azimuth * RAD_TO_DEG),degSymbol)
    print(" El:       ",(smc.sun.elevation * RAD_TO_DEG),degSymbol)
    print(" Dist:     ",smc.sun.distance , " AU")
    print(" RA:       ",(smc.sun.rightAscension * RAD_TO_DEG),degSymbol)
    print(" DEC:      ",(smc.sun.declination * RAD_TO_DEG),degSymbol)
    print(" Ill:      ",(smc.sun.illuminationPhase),  "%")
    print(" Rise:     "+smc.getDateAsString(smc.sun.rise))
    print(" Set:      "+smc.getDateAsString(smc.sun.set))
    print(" Transit:  "+smc.getDateAsString(smc.sun.transit)," (elev. ", (smc.sun.transitElevation * RAD_TO_DEG),degSymbol+")")

    print("###MOON###")
    print(" Az:       ",(smc.moon.azimuth * RAD_TO_DEG),degSymbol)
    print(" El:       ",(smc.moon.elevation * RAD_TO_DEG),degSymbol)
    print(" Dist:     ",int(smc.moon.distance * smc.AU/1000),"km")
    print(" RA:       ",(smc.moon.rightAscension * RAD_TO_DEG),degSymbol)
    print(" DEC:      ",(smc.moon.declination * RAD_TO_DEG),degSymbol)
    ...
    print(" Transit:  "+smc.getDateAsString(smc.moon.transit)," (elev. ", (smc.moon.transitElevation * RAD_TO_DEG),degSymbol+")")
